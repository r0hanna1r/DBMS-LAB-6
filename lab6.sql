...
insert into section values(109,'CS100',5,2010,133);
	
select ctitle from course join section using(ccode) where year=2010 and sem=5;

insert into section values(110,'MAT02',5,2017,134);	

select ctitle from course join section using(ccode) where year=2017 and sem=5;

insert into section values(111,'CS100',5,2017,134);
...
insert into teach values(125,111,'CS100',5,2017);
...
select depname,avg(salary) from instructor group by depname having avg(salary) >45000;
...
select distinct cust_name from customer1,orders1 where customer1.customer_id=orders1.customer_id order by cust_name;

select distinct cust_name from customer1,orders1 where customer1.customer_id=orders1.customer_id and customer1.grade<300 order by cust_name;

insert into customer1 values(3010,'Rakesh Dhawan','Bengaluru',100,5001);

select customer1.cust_name,customer1.city,orders1.ord_no,orders1.ord_date,purch_amt from customer1 left outer join orders1 on 
customer1.customer_id=orders1.customer_id order by ord_date;

insert into customer1 values(3011,'Satish Dhawan','Mumbai',100,null);

insert into orders1 values(70014,40000.59,'2012-05-27',3011,null);

select customer1.cust_name,customer1.city,orders1.ord_no,orders1.ord_date,purch_amt,orders1.ord_date,salesman.name,salesman.commission
from customer1 left outer join orders1 on customer1.customer_id=orders1.customer_id left outer join salesman on salesman.salesman_id=orders1.salesman_id;

select distinct salesman.name from salesman left outer join orders1 on salesman.salesman_id=orders1.salesman_id order by salesman.name;

select distinct salesman.name from salesman left outer join orders1 on salesman.salesman_id=orders1.salesman_id
left outer join customer1 on orders1.customer_id=customer1.customer_id where orders1.purch_amt >2000 and customer1.grade is not null;

select * from salesman cross join customer1;

select * from salesman cross join customer1 where salesman.city=customer1.city;

select * from salesman cross join customer1 where salesman.city=customer1.city and customer1.grade is not null;